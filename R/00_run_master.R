...
source("R/14_table_4a_severity.R")
source("R/14_table_4b_severity.R")
source("R/15_table_5_outcomes.R")
source("R/16_supp_table_sensitivity_analyses.R")
source("R/17_supp_table_aetiology.R")
